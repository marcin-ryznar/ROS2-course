...
class BatteryNode(Node): 
    def __init__(self):
        ...
        self.battery_state_ = "full" #stan baterii
        ...
        self.set_led_client_ = self.create_client(SetLed, "set_led") #stworzenie klienta
    ...
    def check_battery_state(self):
        ...
        if self.battery_state_ == "full":
            if time_now - self.last_time_battery_state_changed_ > 4.0:
                ...
                self.last_time_battery_state_changed_ = time_now #zapisuje oobecny stan baterii
    ...
    def call_set_led(self, led_number, state): #czekamy na serwis 
